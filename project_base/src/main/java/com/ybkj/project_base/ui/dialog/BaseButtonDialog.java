...
public abstract class BaseButtonDialog extends BaseDialog {
    ...
    public BaseButtonDialog(Activity context) {
        super(context, R.style.project_base_common_dialog, R.layout.project_base_dialog_button_base);
...
//        setAlertDialogWidth((int) ResourcesUtil.getDimen(R.dimen.x360));
    ...
    private void initView() {
        ...
        btnCancel = (Button) findViewById(R.id.btn_negative);
        btnConfirm = (Button) findViewById(R.id.btn_positive);
        btnButton = findViewById(R.id.button_btn);
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (onCancelButtonClickListener != null) {
                    onCancelButtonClickListener.cancel(BaseButtonDialog.this, v);
                }
