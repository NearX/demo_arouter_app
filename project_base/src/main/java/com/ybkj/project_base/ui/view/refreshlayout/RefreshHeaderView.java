package com.ybkj.project_base.ui.view.refreshlayout;
...
//    private AnimationDrawable animationRefresh;
    ...
    private void init() {
        View.inflate(getContext(), R.layout.project_base_layout_pull_load_view, this);
        mIvOut = (ImageView) findViewById(R.id.iv_pull_refresh_out);
        mTvState = (TextView) findViewById(R.id.tv_pull_refresh_out_state);
