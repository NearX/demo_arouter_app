package com.ybkj.base.utils.preferences;
...
public class PreferencesUtils extends BasePreferences {
    ...
    public static void saveObject(String key, Object object) {
        if (object == null) {
            removeKey(BaseApplication.getInstance(), key);
            return;
        }
        ...
        try {
            ...
            putString(BaseApplication.getInstance(), key, strBase64);
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
            //关闭资源
    ...
    public static Object getObject(String key, Object defValue) {
        Object object = null;
        String strBase64 = getString(BaseApplication.getInstance(), key, "");
