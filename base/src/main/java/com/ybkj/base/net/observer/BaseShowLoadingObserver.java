package com.ybkj.base.net.observer;
...
import com.ybkj.base.net.HttpCallBack;
import com.ybkj.base.net.exception.HandlerException;
import com.ybkj.base.ui.dialog.LoadingDialog;
import com.ybkj.base.utils.LogUtil;
import com.ybkj.base.utils.ProgressDialogUtil;
...
public class BaseShowLoadingObserver<T> extends BaseObserver<T> {
    ...
    protected void onRequestStart() {
        ...
        if (!SystemManager.isNetworkAvailable(BaseApplication.getInstance())) {
            onRequestError(HandlerException.handleException(new
                    HandlerException.ResponseThrowable(ResourcesUtil.getString(R.string.base_net_connect_error),
                    NetResponseCode
                            .HMC_NETWORK_ERROR)));
